'''
Question 1: How does the method of navigation (clicking on menu vs. direct links) impact loading times on the Books to Scrape website?
Goal A: Using Playwright, measure load times of book categories on BooksToScrape website, by clicking on categories and with NO caching.
'''
...
# Save to JSON
with open("q1a-bts-pw.json", "w") as f:
    json.dump(results, f, indent=2)

# Remark: Is this script actually without caching? Is it a true cold start? If not, why?